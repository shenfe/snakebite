...
class ExtendedBlockProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _EXTENDEDBLOCKPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.ExtendedBlockProto)

class DatanodeIDProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _DATANODEIDPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.DatanodeIDProto)

class DatanodeInfosProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _DATANODEINFOSPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.DatanodeInfosProto)

class DatanodeInfoProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _DATANODEINFOPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.DatanodeInfoProto)

class ContentSummaryProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _CONTENTSUMMARYPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.ContentSummaryProto)

class CorruptFileBlocksProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _CORRUPTFILEBLOCKSPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.CorruptFileBlocksProto)

class FsPermissionProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _FSPERMISSIONPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.FsPermissionProto)

class LocatedBlockProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _LOCATEDBLOCKPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.LocatedBlockProto)

class DataEncryptionKeyProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _DATAENCRYPTIONKEYPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.DataEncryptionKeyProto)

class LocatedBlocksProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _LOCATEDBLOCKSPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.LocatedBlocksProto)

class HdfsFileStatusProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _HDFSFILESTATUSPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.HdfsFileStatusProto)

class FsServerDefaultsProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _FSSERVERDEFAULTSPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.FsServerDefaultsProto)

class DirectoryListingProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _DIRECTORYLISTINGPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.DirectoryListingProto)

class SnapshottableDirectoryStatusProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
...
class SnapshottableDirectoryListingProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
