...
class DataTransferEncryptorMessageProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
...
class BaseHeaderProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _BASEHEADERPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.BaseHeaderProto)

class ClientOperationHeaderProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _CLIENTOPERATIONHEADERPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.ClientOperationHeaderProto)

class CachingStrategyProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _CACHINGSTRATEGYPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.CachingStrategyProto)

class OpReadBlockProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _OPREADBLOCKPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.OpReadBlockProto)

class ChecksumProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _CHECKSUMPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.ChecksumProto)

class OpWriteBlockProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _OPWRITEBLOCKPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.OpWriteBlockProto)

class OpTransferBlockProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _OPTRANSFERBLOCKPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.OpTransferBlockProto)

class OpReplaceBlockProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _OPREPLACEBLOCKPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.OpReplaceBlockProto)

class OpCopyBlockProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _OPCOPYBLOCKPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.OpCopyBlockProto)

class OpBlockChecksumProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _OPBLOCKCHECKSUMPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.OpBlockChecksumProto)

class OpRequestShortCircuitAccessProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
...
class PacketHeaderProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _PACKETHEADERPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.PacketHeaderProto)

class PipelineAckProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _PIPELINEACKPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.PipelineAckProto)

class ReadOpChecksumInfoProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _READOPCHECKSUMINFOPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.ReadOpChecksumInfoProto)

class BlockOpResponseProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _BLOCKOPRESPONSEPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.BlockOpResponseProto)

class ClientReadStatusProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _CLIENTREADSTATUSPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.ClientReadStatusProto)

class DNTransferAckProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _DNTRANSFERACKPROTO

  # @@protoc_insertion_point(class_scope:hadoop.hdfs.DNTransferAckProto)

class OpBlockChecksumResponseProto(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
